...
HD_PWD='D:/DSD_lab/IPBlocks/IPBlocks.runs/design_1_clk_10_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clk_10_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clk_10_1_0_0.tcl
