...
HD_PWD='D:/DSD_lab/CarrySelectAdder/CarrySelectAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log carryselectadder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source carryselectadder.tcl -notrace
