...
HD_PWD='D:/DSD_lab/ATM MACHINE_Final/ATM MACHINE_Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atm_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atm_machine.tcl
