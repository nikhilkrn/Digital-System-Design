...
HD_PWD='D:/DSD_lab/ATM MACHINE_Final/ATM MACHINE_Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log atm_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source atm_machine.tcl -notrace
