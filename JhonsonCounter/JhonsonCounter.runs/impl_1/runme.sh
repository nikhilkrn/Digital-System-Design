...
HD_PWD='D:/DSD_lab/JhonsonCounter/JhonsonCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log johnson_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source johnson_counter.tcl -notrace
