...
HD_PWD='D:/DSD_lab/JhonsonCounter/JhonsonCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log johnson_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source johnson_counter.tcl
